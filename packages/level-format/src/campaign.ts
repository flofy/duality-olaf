...
const world1Source: Level[] = [
  makeLevel(
    ...
    p(2, 1),
    [p(5, 1), p(5, 7)],
    [p(3, 2), p(4, 2), p(5, 2), p(7, 5), p(8, 5), p(9, 5)],
  ),
  makeLevel(
    2,
    p(1, 8),
    p(2, 8),
    [p(11, 1), p(6, 4)],
    [p(4, 2), p(4, 3), p(4, 4), p(8, 5), p(8, 6), p(8, 7)],
  ),
  makeLevel(
    3,
    p(1, 1),
    p(2, 2),
    [p(11, 1), p(11, 8), p(1, 8)],
    [p(3, 3), p(4, 3), p(5, 3), p(7, 6), p(8, 6), p(9, 6)],
  ),
  makeLevel(
    4,
    p(11, 8),
    p(9, 8),
    [p(1, 1), p(6, 2), p(6, 7)],
    [p(3, 2), p(3, 3), p(3, 4), p(9, 5), p(9, 6), p(9, 7)],
  ),
  makeLevel(
    5,
    p(1, 1),
    p(11, 8),
    [p(11, 1), p(1, 8), p(6, 5)],
    [p(5, 2), p(6, 2), p(7, 2), p(5, 7), p(6, 7), p(7, 7)],
  ),
  makeLevel(
    6,
    p(1, 4),
    p(11, 4),
    [p(3, 1), p(6, 8), p(10, 1)],
    [p(2, 3), p(3, 3), p(4, 3), p(8, 6), p(9, 6), p(10, 6)],
  ),
  makeLevel(
    7,
    p(2, 8),
    p(2, 1),
    [p(10, 8), p(10, 1), p(6, 5)],
    [p(4, 2), p(5, 2), p(6, 2), p(6, 7), p(7, 7), p(8, 7)],
  ),
  makeLevel(
    8,
    p(1, 1),
    p(1, 8),
    [p(11, 1), p(11, 8), p(6, 4), p(6, 6)],
    [p(3, 4), p(4, 4), p(5, 4), p(7, 5), p(8, 5), p(9, 5)],
  ),
  makeLevel(
    9,
    p(11, 8),
    p(11, 1),
    [p(1, 8), p(1, 1), p(6, 2), p(6, 7)],
    [p(2, 2), p(2, 3), p(2, 4), p(10, 5), p(10, 6), p(10, 7)],
  ),
  makeLevel(
    10,
    p(1, 1),
    p(3, 8),
    [p(11, 1), p(11, 8), p(6, 3), p(6, 6)],
    [p(4, 3), p(5, 3), p(7, 3), p(8, 3), p(4, 6), p(5, 6), p(7, 6), p(8, 6)],
  ),
  makeLevel(
    11,
    p(1, 8),
    p(11, 1),
    [p(1, 1), p(11, 8), p(6, 4), p(6, 7)],
    [p(3, 2), p(3, 3), p(3, 6), p(3, 7), p(9, 2), p(9, 3), p(9, 6), p(9, 7)],
  ),
];
 ...
 */
export const world1: Level[] = world1Order.map(
  (number) => world1Source[number - 1],
);
...
export const world2: Level[] = [
  ...
  makeWorld2Level(
    ...
    p(10, 8),
    [p(6, 1), p(6, 8), p(3, 5)],
    [p(5, 3), p(6, 3), p(7, 3), p(5, 6), p(6, 6), p(7, 6)],
  ),
  makeWorld2Level(
    4,
    p(1, 4),
    p(11, 4),
    [p(3, 1), p(9, 8), p(6, 4)],
    [p(4, 2), p(4, 3), p(4, 6), p(4, 7), p(8, 2), p(8, 3), p(8, 6), p(8, 7)],
  ),
  makeWorld2Level(
    5,
    p(1, 1),
  ...
  makeWorld2Level(
    ...
    p(2, 1),
    p(10, 8),
    [p(5, 2), p(7, 2), p(5, 7), p(7, 7), p(6, 4), p(6, 5)],
    [p(4, 2), p(4, 3), p(4, 4), p(8, 5), p(8, 6), p(8, 7)],
  ),
  makeWorld2Level(
    11,
    p(1, 4),
    p(11, 5),
    [p(2, 1), p(10, 1), p(2, 8), p(10, 8), p(6, 3), p(6, 6)],
    [p(3, 2), p(3, 3), p(3, 6), p(3, 7), p(9, 2), p(9, 3), p(9, 6), p(9, 7)],
  ),
];
