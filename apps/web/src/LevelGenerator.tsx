    ...
    return (
      <section className="generator-player">
        ...
        <LabGame
          ...
          themeName="retro"
          onCompletionChange={() => {}}
          optimalMoves={selected.validation.difficulty?.moves}
          onBackToGenerator={() => setSelectedSeed(null)}
        />
      </section>
    );
    ...
    <section className="dev-generator">
      ...
      <div className="generator-options">
        <label>
          ...
          <input
            ...
            value={options.seed}
            onChange={(e) =>
              setOptions({ ...options, seed: Number(e.target.value) || 1 })
            }
          />
        </label>
        <label>
        ...
        <label>
          ...
          <select
            value={options.stars}
            onChange={(e) =>
              setOptions({ ...options, stars: Number(e.target.value) })
            }
          >
          ...
          return (
            ...
            >
              ...
              <div className="generator-card-meta">
                <b>SEED {level.seed}</b>
                <span>
                  ✓ {difficulty.moves} coups · score {difficulty.score}
                </span>
              </div>
            </button>
          );
      ...
      {candidates.length === 0 && (
        <div className="generator-empty">
          Aucun niveau solvable trouvé. Réduis les murs ou génère une nouvelle
          série.
        </div>
      )}
    </section>
