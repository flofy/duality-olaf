...
const face = (expression: CharacterExpression) => {
  switch (expression) {
    case "happy":
      return { eyeY: 10.5, mouth: "happy" };
    case "surprised":
      return { eyeY: 10, mouth: "surprised" };
    case "angry":
      return { eyeY: 10.5, mouth: "angry" };
    case "tired":
      return { eyeY: 11.5, mouth: "tired" };
    case "defeated":
      return { eyeY: 11, mouth: "defeated" };
    default:
      return { eyeY: 10.8, mouth: "neutral" };
  }
};
      ...
      {expression !== "angry" && (
        <>
          ...
          <ellipse
            ...
            fill="#fff"
          />
          <circle cx="9" cy={f.eyeY + 0.2} r="1.05" fill="#172554" />
          <circle cx="15" cy={f.eyeY + 0.2} r="1.05" fill="#172554" />
          <circle cx="9.35" cy={f.eyeY - 0.25} r=".35" fill="#fff" />
          <circle cx="15.35" cy={f.eyeY - 0.25} r=".35" fill="#fff" />
        </>
      )}
      {expression === "angry" && (
        <>
          <ellipse cx="8.7" cy="10.8" rx="1.7" ry="2" fill="#fff" />
          <ellipse cx="15.3" cy="10.8" rx="1.7" ry="2" fill="#fff" />
          <circle cx="9" cy="11" r="1" fill="#172554" />
          <circle cx="15" cy="11" r="1" fill="#172554" />
        </>
      )}
      {expression === "happy" && (
        <path
...
export function BallCharacter({
  ...
  return (
    ...
    >
      ...
      <path
        d="M6.3 17.2c-1.1 1.8-.5 3.1.8 3.5 1.3.4 2.1-.7 2.3-2.1M17.7 17.2c1.1 1.8.5 3.1-.8 3.5-1.3.4-2.1-.7-2.3-2.1"
        fill={color}
        stroke="#12529a"
        strokeWidth=".55"
      />
