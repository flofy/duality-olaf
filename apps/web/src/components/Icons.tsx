...
export const Spike = ({ size = 24, color = "#ff4444", className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", margin: "0 auto" }}>
...
export const Star = ({ size = 24, color = "#ffd700", className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", margin: "0 auto" }}>
    <path d="M12 2L14.5 9.5L22 10.5L16 14L17.5 21L12 18L6.5 21L8 14L2 10.5L9.5 9.5L12 2Z" />
    <path d="M12 4L13 8L16 8L14 11L15 15L12 13L9 15L10 11L8 8L11 8L12 4Z" fill="white" opacity={0.3} />
  </svg>
);
...
export const Teleporter = ({ size = 24, color = "#9b59b6", className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", margin: "0 auto" }}>
    ...
    <radialGradient id="teleporterGlow" cx="12" cy="12" r="8" gradientUnits="userSpaceOnUse">
...
export const SwitchIcon = ({ size = 24, color = "#ffd447", form = "either", className }: IconProps & { form?: "ball" | "square" | "either" }) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", margin: "0 auto" }}>
      ...
      <text x="12" y="15" fontSize="10" textAnchor="middle" fill="white" fontWeight="bold">{glyph}</text>
...
export const ResetIcon = ({ size = 24, color = "#fff", className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", margin: "0 auto" }}>
    <path d="M3 12C3 12 5 8 12 8C19 8 21 10 21 12C21 14 19 16 12 16C5 16 3 14 3 12Z" stroke={color} strokeWidth="2" />
...
export const Maximize = ({ size = 24, color = "#fff", className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", margin: "0 auto" }}>
    ...
    <path d="M18 18L20 20" stroke={color} strokeWidth="2" strokeLinecap="round" />
...
export const Minimize = ({ size = 24, color = "#fff", className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", margin: "0 auto" }}>
    ...
    <rect x="5" y="5" width="14" height="14" rx="1" stroke={color} strokeWidth="1" opacity={0.3} />
  </svg>
);
...
export const Help = ({ size = 24, color = "#fff", className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", margin: "0 auto" }}>
    ...
    <circle cx="12" cy="12" r="1" fill={color} />
    <path d="M12 18C12 18 8 16 8 14C8 10 12 10 12 14C12 14 16 16 16 14C16 10 12 10 12 14Z" fill="none" stroke={color} strokeWidth="1.5" />
  </svg>
);
...
export const ThemeIcon = ({ size = 24, color = "#fff", className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", margin: "0 auto" }}>
    ...
    <path d="M4.93 4.93L6.36 6.36" stroke={color} strokeWidth="2" strokeLinecap="round" />
    <path d="M17.64 17.64L19.07 19.07" stroke={color} strokeWidth="2" strokeLinecap="round" />
    <path d="M4.93 19.07L6.36 17.64" stroke={color} strokeWidth="2" strokeLinecap="round" />
    <path d="M17.64 6.36L19.07 4.93" stroke={color} strokeWidth="2" strokeLinecap="round" />
  </svg>
);
