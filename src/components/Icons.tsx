...
export const Star = ({ size = 24, color = "#ffd700", className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} xmlns="http://www.w3.org/2000/svg" className={className} style={iconStyle}>
...
export const Door = ({ size = 24, color = "#7a5c3d", isOpen = false, className }: IconProps & { isOpen?: boolean }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={iconStyle}>
    ...
    {!isOpen ? (
      <><rect x="8" y="10" width="8" height="4" rx="1" fill="#3a2718" /><circle cx="12" cy="12" r="0.5" fill="#ffd447" /></>
    ) : (
